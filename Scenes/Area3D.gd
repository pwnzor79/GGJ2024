...
func _ready():
	...
	willie_scream_stream = get_node("/root/Control/CadeScene/enemy/CharacterBody3D/CollisionShape3D/willie_scream")
...
func _on_body_entered(body):
	...
	if (!chase_active):
		...
		var spawn_pos = get_node("/root/Control/CadeScene/enemy/spawn").position
